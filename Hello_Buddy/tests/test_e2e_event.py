...
class TestCreateEvent(StaticLiveServerTestCase):
    ...
    def test_redirect_create_event_page(self):
        ...
        self.login_id1()
        but_create = self.browser.find_element(By.XPATH , "/html/body/nav/div/ul[1]/li[4]/a")
        but_create.click()
    ...
    def test_create_event(self):
        ...
        name = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[1]/div/div/input")
        place = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[2]/div/div/input")
        time = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[5]/div/div/div/input")
        
        name.send_keys("e2e_test1")
        place.send_keys("kaset")
        time.send_keys("01:00:00")
        
        sub = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[8]/button[2]")
        sub.click()
    ...
    def test_create_event_wrong_place_submit(self):
        ...
        name = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[1]/div/div/input")
        place = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[2]/div/div/input")
        time_ = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[5]/div/div/div/input")
    ...
    def test_create_event_wrong_place_check_place(self):
        ...
        sub = self.browser.find_element(By.XPATH, "/html/body/div[2]/form/div[8]/button[1]")
        sub.click()
        time.sleep(1)
    ...
    def test_in_to_event_created(self):
        ...
        event_ = self.browser.find_element(By.XPATH, "/html/body/div/div/div/a/div/div/img")
        event_.click()
    ...
    def test_join_event_another_user(self):
        ...
        event_page = self.browser.find_element(By.XPATH, "/html/body/div/div/div/a/div/div/img")
        event_page.click()
        time.sleep(1)
        assert "Participant: 0/1" in self.browser.page_source
        
        join_ = self.browser.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div/form/button")
        join_.click()
